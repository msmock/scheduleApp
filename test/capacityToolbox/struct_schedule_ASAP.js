...
child_1.buildAction('Consume Ingredient 1', ['Ingredient 1'], {
  quantity: -5,
  duration: 0
});

child_1.buildAction('Consume Ingredient 1', ['Ingredient 2'], {
  quantity: -10,
  duration: 0
});
...
child_2.buildAction('Use Facility 1', ['Facility 1'], {
  quantity: 1,
  duration: 3000
});

child_2.buildAction('Produce Product 1', ['Product 1'], {
  quantity: 5,
  duration: 0
});
...
_algorithm.schedule(activity, actors, 1000, 'ASAP');
